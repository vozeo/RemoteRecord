...
}(), p.useArrayBufferView = !p.useBlobBuilder && function () {
    try {
...
"undefined" != typeof window && (d = i = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder), u.prototype.append = function (e) {
    "number" == typeof e ? this._pieces.push(e) : (this.flush(), this._parts.push(e))
}, u.prototype.flush = function () {
    if (this._pieces.length > 0) {
        var e = new Uint8Array(this._pieces);
        p.useArrayBufferView || (e = e.buffer), this._parts.push(e), this._pieces = []
    }
}, u.prototype.getBuffer = function () {
    if (this.flush(), p.useBlobBuilder) {
        for (var e = new d, t = 0, r = this._parts.length; t < r; t++) e.append(this._parts[t]);
        return e.getBlob()
    }
...
r = {
    ...
    for (var t, r, n = this.read(e), i = 0, o = ""; i < e;)(t = n[i]) < 128 ? (o += String.fromCharCode(t), i++) : (192 ^ t) < 32 ? (r = (192 ^ t) << 6 | 63 & n[i + 1], o += String.fromCharCode(r), i += 2) : (r = (15 & t) << 12 | (63 & n[i + 1]) << 6 | 63 & n[i + 2], o += String.fromCharCode(r), i += 3);
    ...
    var e = this.unpack_uint32(),
        ...
        r = (e >> 20 & 2047) - 1023;
    return (0 === e >> 31 ? 1 : -1) * ((1048575 & e | 1048576) * Math.pow(2, r - 20) + t * Math.pow(2, r - 52))
    ...
    if ("string" === t) this.pack_string(e);
        ...
        if (null === e) this.bufferBuilder.append(192);
            ...
            else if (r == ArrayBuffer) f.useArrayBufferView ? this.pack_bin(new Uint8Array(e)) : this.pack_bin(e);
            else if ("BYTES_PER_ELEMENT" in e) f.useArrayBufferView ? this.pack_bin(new Uint8Array(e.buffer)) : this.pack_bin(e.buffer);
            else if (r == Object || r.toString().startsWith("class")) this.pack_object(e);
            else if (r == Date) this.pack_string(e.toString());
            else {
                if ("function" != typeof e.toBinaryPack) throw new Error('Type "' + r.toString() + '" not yet supported');
    ...
    var t = function (e) {
        return e.length > 600 ? new Blob([e]).size : e.replace(/[^\u0000-\u007F]/g, v).length
    }(e);
    ...
    else if (e >= -0x8000000000000000 && e <= 0x8000000000000000) this.bufferBuilder.append(211), this.pack_int64(e);
    else {
    ...
    var t = e / Math.pow(2, 32),
        r = e % Math.pow(2, 32);
    this.bufferBuilder.append((4278190080 & t) >>> 24), this.bufferBuilder.append((16711680 & t) >>> 16), this.bufferBuilder.append((65280 & t) >>> 8), this.bufferBuilder.append(255 & t), this.bufferBuilder.append((4278190080 & r) >>> 24), this.bufferBuilder.append((16711680 & r) >>> 16), this.bufferBuilder.append((65280 & r) >>> 8), this.bufferBuilder.append(255 & r)
...
function _(e) {
    return "boolean" != typeof e ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.") : (y = e, e ? "adapter.js logging disabled" : "adapter.js logging enabled")
}

function S(e) {
    return "boolean" != typeof e ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.") : (g = !e, "adapter.js deprecation warnings " + (e ? "disabled" : "enabled"))
}
...
function w(e) {
    ...
    var r = e.navigator;
    if (r.mozGetUserMedia) t.browser = "firefox", t.version = C(r.userAgent, /Firefox\/(\d+)\./, 1);
    else if (r.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer) t.browser = "chrome", t.version = C(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2);
    else if (r.mediaDevices && r.userAgent.match(/Edge\/(\d+).(\d+)$/)) t.browser = "edge", t.version = C(r.userAgent, /Edge\/(\d+).(\d+)$/, 2);
    else {
        if (!e.RTCPeerConnection || !r.userAgent.match(/AppleWebKit\/(\d+)\./)) return t.browser = "Not a supported browser.", t;
        t.browser = "safari", t.version = C(r.userAgent, /AppleWebKit\/(\d+)\./, 1), t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection" in e.RTCRtpTransceiver.prototype
    }
    return t
}
...
function E(e, t, r) {
    t && !r.has(t.id) && (r.set(t.id, t), Object.keys(t).forEach((function (n) {
        n.endsWith("Id") ? E(e, e.get(t[n]), r) : n.endsWith("Ids") && t[n].forEach((function (t) {
            E(e, e.get(t), r)
        }))
    })))
}
        ...
        var n = function (e) {
            ...
            i = function (e, i) {
                ...
                if (e && "object" == typeof e.video) {
                    ...
                    if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c))
                        if (delete e.video.facingMode, "environment" === a.exact || "environment" === a.ideal ? s = ["back", "rear"] : "user" !== a.exact && "user" !== a.ideal || (s = ["front"]), s) return r.mediaDevices.enumerateDevices().then((function (t) {
                            ...
                            return !r && t.length && s.includes("back") && (r = t[t.length - 1]), r && (e.video.deviceId = a.exact ? {
                                exact: r.deviceId
                            } : {
                                ideal: r.deviceId
                            }), e.video = n(e.video), O("chrome: " + JSON.stringify(e)), i(e)
                        }));
                    e.video = n(e.video)
                }
...
function U(e, t) {
    ...
    if (e.RTCPeerConnection) {
        ...
        e.RTCPeerConnection.prototype.removeStream = function (e) {
            ...
            if (o) {
                var a = this;
                o.addTrack(t), Promise.resolve().then((function () {
...
function G(e, t) {
    b(e, "negotiationneeded", (function (e) {
        var r = e.target;
...
function K(e, t, r, n, i) {
    ...
    if (o += W.writeIceParameters(e.iceGatherer.getLocalParameters()), o += W.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active"), o += "a=mid:" + e.mid + "\r\n", e.rtpSender && e.rtpReceiver ? o += "a=sendrecv\r\n" : e.rtpSender ? o += "a=sendonly\r\n" : e.rtpReceiver ? o += "a=recvonly\r\n" : o += "a=inactive\r\n", e.rtpSender) {
...
function ee(t, r) {
    if (t.RTCIceGatherer && (t.RTCIceCandidate || (t.RTCIceCandidate = function (e) {
        return e
    }), t.RTCSessionDescription || (t.RTCSessionDescription = function (e) {
        return e
    }), r.version < 15025)) {
    ...
    t.RTCPeerConnection = function (e) {
        var t, n;
        return e && e.iceServers && (e.iceServers = (t = e.iceServers, r.version, n = !1, (t = JSON.parse(JSON.stringify(t))).filter((function (e) {
            if (e && (e.urls || e.url)) {
                var t = e.urls || e.url;
        ...
        }))), T("ICE servers after filtering:", e.iceServers)), new i(e)
...
H.generateIdentifier = function () {
...
}, H.localCName = H.generateIdentifier(), H.splitLines = function (e) {
    return e.trim().split("\n").map((function (e) {
        return e.trim()
    }))
    ...
    return {
        role: "auto",
        fingerprints: H.matchPrefix(e + t, "a=fingerprint:").map(H.parseFingerprint)
    }
    ...
    return "a=crypto:" + e.tag + " " + e.cryptoSuite + " " + ("object" == typeof e.keyParams ? H.writeCryptoKeyParams(e.keyParams) : e.keyParams) + (e.sessionParams ? " " + e.sessionParams.join(" ") : "") + "\r\n"
    ...
    for (var t = {
        ...
        fecMechanisms: [],
        rtcp: []
    }, r = H.splitLines(e)[0].split(" "), n = 3; n < r.length; n++) {
        var i = r[n],
            o = H.matchPrefix(e, "a=rtpmap:" + i + " ")[0];
        if (o) {
            var a = H.parseRtpMap(o),
                s = H.matchPrefix(e, "a=fmtp:" + i + " ");
            switch (a.parameters = s.length ? H.parseFmtp(s[0]) : {}, a.rtcpFeedback = H.matchPrefix(e, "a=rtcp-fb:" + i + " ").map(H.parseRtcpFb), t.codecs.push(a), a.name.toUpperCase()) {
            case "RED":
            case "ULPFEC":
    ...
    return H.matchPrefix(e, "a=extmap:").forEach((function (e) {
    ...
    r += "m=" + e + " ", r += t.codecs.length > 0 ? "9" : "0", r += " UDP/TLS/RTP/SAVPF ", r += t.codecs.map((function (e) {
        ...
        r += H.writeRtpMap(e), r += H.writeFmtp(e), r += H.writeRtcpFb(e)
    }));
    var n = 0;
    ...
    var t, r = [],
        ...
        a = H.matchPrefix(e, "a=ssrc:").map((function (e) {
    ...
    c.length > 0 && c[0].length > 1 && c[0][0] === s && (t = c[0][1]), n.codecs.forEach((function (e) {
    ...
    return p.length && (p = 0 === p[0].indexOf("b=TIAS:") ? parseInt(p[0].substr(7), 10) : 0 === p[0].indexOf("b=AS:") ? 950 * parseInt(p[0].substr(5), 10) - 16e3 : void 0, r.forEach((function (e) {
        e.maxBitrate = p
    }))), r
}, H.parseRtcpParameters = function (e) {
    var t = {},
        r = H.matchPrefix(e, "a=ssrc:").map((function (e) {
            return H.parseSsrcMedia(e)
        })).filter((function (e) {
            return "cname" === e.attribute
        }))[0];
    ...
    var t, r = H.matchPrefix(e, "a=msid:");
    if (1 === r.length) return {
        stream: (t = r[0].substr(7).split(" "))[0],
        track: t[1]
    };
    var n = H.matchPrefix(e, "a=ssrc:").map((function (e) {
        return H.parseSsrcMedia(e)
    })).filter((function (e) {
    ...
    if (i += H.writeIceParameters(e.iceGatherer.getLocalParameters()), i += H.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : "active"), i += "a=mid:" + e.mid + "\r\n", e.direction ? i += "a=" + e.direction + "\r\n" : e.rtpSender && e.rtpReceiver ? i += "a=sendrecv\r\n" : e.rtpSender ? i += "a=sendonly\r\n" : e.rtpReceiver ? i += "a=recvonly\r\n" : i += "a=inactive\r\n", e.rtpSender) {
    ...
    for (var r = H.splitLines(e), n = 0; n < r.length; n++) switch (r[n]) {
    case "a=sendrecv":
    case "a=sendonly":
    case "a=recvonly":
    case "a=inactive":
    ...
    var r = function (t, r) {
        ...
        i = function (r) {
            ...
            if (["addEventListener", "removeEventListener", "dispatchEvent"].forEach((function (e) {
                n[e] = i[e].bind(i)
            })), this.canTrickleIceCandidates = null, this.needNegotiation = !1, this.localStreams = [], this.remoteStreams = [], this._localDescription = null, this._remoteDescription = null, this.signalingState = "stable", this.iceConnectionState = "new", this.connectionState = "new", this.iceGatheringState = "new", r = JSON.parse(JSON.stringify(r || {})), this.usingBundle = "max-bundle" === r.bundlePolicy, "negotiate" === r.rtcpMuxPolicy) throw X("NotSupportedError", "rtcpMuxPolicy 'negotiate' is not supported");
            ...
            this._config = r, this.transceivers = [], this._sdpSessionId = W.generateSessionId(), this._sdpSessionVersion = 0, this._dtlsRole = void 0, this._isClosed = !1
        };
    Object.defineProperty(i.prototype, "localDescription", {
        ...
        if (this._isClosed) throw X("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
        var n;
        ...
        if (this._isClosed) throw X("InvalidStateError", "Attempted to call removeTrack on a closed peerconnection.");
        ...
        if (!r) throw X("InvalidAccessError", "Sender was not created by this connection.");
        var n = r.stream;
            ...
            this.transceivers[r].bufferedCandidateEvents = null, i.removeEventListener("localcandidate", this.transceivers[r].bufferCandidates), i.onlocalcandidate = function (e) {
                if (!(n.usingBundle && r > 0)) {
                    ...
                    if (s) "new" !== i.state && "gathering" !== i.state || (i.state = "completed");
                        ...
                        o.candidate = Object.assign(o.candidate, W.parseCandidate(c)), o.candidate.candidate = c, o.candidate.toJSON = function () {
                            return {
                    ...
                    p[o.candidate.sdpMLineIndex] += s ? "a=end-of-candidates\r\n" : "a=" + o.candidate.candidate + "\r\n", n._localDescription.sdp = W.getDescription(n._localDescription.sdp) + p.join("");
                    var d = n.transceivers.every((function (e) {
                        return e.iceGatherer && "completed" === e.iceGatherer.state
                    }));
                    "gathering" !== n.iceGatheringState && (n.iceGatheringState = "gathering", n._emitGatheringStateChange()), s || n._dispatchEvent("icecandidate", o), d && (n._dispatchEvent("icecandidate", new Event("icecandidate")), n.iceGatheringState = "complete", n._emitGatheringStateChange())
                }
        ...
        var t, r, n = this;
        if (-1 === ["offer", "answer"].indexOf(e.type)) return Promise.reject(X("TypeError", 'Unsupported type "' + e.type + '"'));
        if (!q("setLocalDescription", e.type, n.signalingState) || n._isClosed) return Promise.reject(X("InvalidStateError", "Can not set local " + e.type + " in state " + n.signalingState));
        if ("offer" === e.type) t = W.splitSections(e.sdp), r = t.shift(), t.forEach((function (e, t) {
            ...
            t.forEach((function (e, t) {
                ...
                if (!(W.isRejected(e) && 0 === W.matchPrefix(e, "a=bundle-only").length) && !o.rejected) {
                    var u = W.getIceParameters(e, r),
                        l = W.getDtlsParameters(e, r);
                    i && (l.role = "server"), n.usingBundle && 0 !== t || (n._gather(o.mid, t), "new" === s.state && s.start(a, u, i ? "controlling" : "controlled"), "new" === c.state && c.start(l));
                    var f = Y(p, d);
        ...
        var o = this;
        if (-1 === ["offer", "answer"].indexOf(i.type)) return Promise.reject(X("TypeError", 'Unsupported type "' + i.type + '"'));
        if (!q("setRemoteDescription", i.type, o.signalingState) || o._isClosed) return Promise.reject(X("InvalidStateError", "Can not set remote " + i.type + " in state " + o.signalingState));
        var a = {};
        ...
        return o.canTrickleIceCandidates = !!l && l.substr(14).split(" ").indexOf("trickle") >= 0, c.forEach((function (n, c) {
            var l = W.splitLines(n),
                f = W.getKind(n),
                h = W.isRejected(n) && 0 === W.matchPrefix(n, "a=bundle-only").length,
            ...
            if (h || "application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m)) o.transceivers[c] = {
                ...
                var C, b, _, S, T, k, w, P, R;
                !h && o.transceivers[c] && o.transceivers[c].rejected && (o.transceivers[c] = o._createTransceiver(f, !0));
                var E, x, D = W.parseRtpParameters(n);
                h || (E = W.getIceParameters(n, p), (x = W.getDtlsParameters(n, p)).role = "client"), w = W.parseRtpEncodingParameters(n);
                var O = W.parseRtcpParameters(n),
                    I = W.matchPrefix(n, "a=end-of-candidates", p).length > 0,
                    M = W.matchPrefix(n, "a=candidate:").map((function (e) {
                        return W.parseCandidate(e)
                    })).filter((function (e) {
                        return 1 === e.component
                    }));
                if (("offer" === i.type || "answer" === i.type) && !h && u && c > 0 && o.transceivers[c] && (o._disposeIceAndDtlsTransports(c), o.transceivers[c].iceGatherer = o.transceivers[0].iceGatherer, o.transceivers[c].iceTransport = o.transceivers[0].iceTransport, o.transceivers[c].dtlsTransport = o.transceivers[0].dtlsTransport, o.transceivers[c].rtpSender && o.transceivers[c].rtpSender.setTransport(o.transceivers[0].dtlsTransport), o.transceivers[c].rtpReceiver && o.transceivers[c].rtpReceiver.setTransport(o.transceivers[0].dtlsTransport)), "offer" !== i.type || h) {
                    if ("answer" === i.type && !h) {
                        b = (C = o.transceivers[c]).iceGatherer, _ = C.iceTransport, S = C.dtlsTransport, T = C.rtpReceiver, k = C.sendEncodingParameters, P = C.localCapabilities, o.transceivers[c].recvEncodingParameters = w, o.transceivers[c].remoteCapabilities = D, o.transceivers[c].rtcpParameters = O, M.length && "new" === _.state && (!d && !I || u && 0 !== c ? M.forEach((function (e) {
                            Q(C.iceTransport, e)
                        })) : _.setRemoteCandidates(M)), u && 0 !== c || ("new" === _.state && _.start(b, E, "controlling"), "new" === S.state && S.start(x)), !Y(C.localCapabilities, C.remoteCapabilities).codecs.filter((function (e) {
                            return "rtx" === e.name.toLowerCase()
                        })).length && C.sendEncodingParameters[0].rtx && delete C.sendEncodingParameters[0].rtx, o._transceive(C, "sendrecv" === v || "recvonly" === v, "sendrecv" === v || "sendonly" === v), !T || "sendrecv" !== v && "sendonly" !== v ? delete C.rtpReceiver : (R = T.track, y ? (a[y.stream] || (a[y.stream] = new e.MediaStream), r(R, a[y.stream]), s.push([R, T, a[y.stream]])) : (a.default || (a.default = new e.MediaStream), r(R, a.default), s.push([R, T, a.default])))
                    }
                }
                else {
                    (C = o.transceivers[c] || o._createTransceiver(f)).mid = g, C.iceGatherer || (C.iceGatherer = o._createIceGatherer(c, u)), M.length && "new" === C.iceTransport.state && (!I || u && 0 !== c ? M.forEach((function (e) {
                        Q(C.iceTransport, e)
                    })) : C.iceTransport.setRemoteCandidates(M)), P = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (P.codecs = P.codecs.filter((function (e) {
                        return "rtx" !== e.name
                    ...
                    if ("sendrecv" === v || "sendonly" === v) {
                        if (A = !C.rtpReceiver, T = C.rtpReceiver || new e.RTCRtpReceiver(C.dtlsTransport, f), A) R = T.track, y && "-" === y.stream || (y ? (a[y.stream] || (a[y.stream] = new e.MediaStream, Object.defineProperty(a[y.stream], "id", {
                            get: function () {
                                return y.stream
                            }
                        ...
                        }), j = a[y.stream]) : (a.default || (a.default = new e.MediaStream), j = a.default)), j && (r(R, j), C.associatedRemoteMediaStreams.push(j)), s.push([R, T, j])
                    }
                    ...
                    C.localCapabilities = P, C.remoteCapabilities = D, C.rtpReceiver = T, C.rtcpParameters = O, C.sendEncodingParameters = k, C.recvEncodingParameters = w, o._transceive(o.transceivers[c], !1, A)
                }
            }
        ...
        var r = this;
        if (r._isClosed) return Promise.reject(X("InvalidStateError", "Can not call createOffer after close"));
        ...
        if (o) {
            ...
            void 0 !== o.offerToReceiveAudio && (n = !0 === o.offerToReceiveAudio ? 1 : !1 === o.offerToReceiveAudio ? 0 : o.offerToReceiveAudio), void 0 !== o.offerToReceiveVideo && (i = !0 === o.offerToReceiveVideo ? 1 : !1 === o.offerToReceiveVideo ? 0 : o.offerToReceiveVideo)
        }
        for (r.transceivers.forEach((function (e) {
            "audio" === e.kind ? --n < 0 && (e.wantReceive = !1) : "video" === e.kind && --i < 0 && (e.wantReceive = !1)
        })); n > 0 || i > 0;) n > 0 && (r._createTransceiver("audio"), n--), i > 0 && (r._createTransceiver("video"), i--);
        var a = W.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
        r.transceivers.forEach((function (n, i) {
            ...
            var p = n.sendEncodingParameters || [{
                ssrc: 1001 * (2 * i + 1)
            }];
            o && t >= 15019 && "video" === a && !p[0].rtx && (p[0].rtx = {
                ssrc: p[0].ssrc + 1
            }), n.wantReceive && (n.rtpReceiver = new e.RTCRtpReceiver(n.dtlsTransport, a)), n.localCapabilities = c, n.sendEncodingParameters = p
        })), "max-compat" !== r._config.bundlePolicy && (a += "a=group:BUNDLE " + r.transceivers.map((function (e) {
            return e.mid
        })).join(" ") + "\r\n"), a += "a=ice-options:trickle\r\n", r.transceivers.forEach((function (e, t) {
            a += K(e, e.localCapabilities, "offer", e.stream, r._dtlsRole), a += "a=rtcp-rsize\r\n", !e.iceGatherer || "new" === r.iceGatheringState || 0 !== t && r.usingBundle || (e.iceGatherer.getLocalCandidates().forEach((function (e) {
                e.component = 1, a += "a=" + W.writeCandidate(e) + "\r\n"
        ...
        var r = this;
        if (r._isClosed) return Promise.reject(X("InvalidStateError", "Can not call createAnswer after close"));
        if ("have-remote-offer" !== r.signalingState && "have-local-pranswer" !== r.signalingState) return Promise.reject(X("InvalidStateError", "Can not call createAnswer in signalingState " + r.signalingState));
        var n = W.writeSessionBoilerplate(r._sdpSessionId, r._sdpSessionVersion++);
        ...
        r.transceivers.forEach((function (e, o) {
            if (!(o + 1 > i)) {
                ...
                !s.codecs.filter((function (e) {
                    return "rtx" === e.name.toLowerCase()
                })).length && e.sendEncodingParameters[0].rtx && delete e.sendEncodingParameters[0].rtx, n += K(e, s, "answer", e.stream, r._dtlsRole), e.rtcpParameters && e.rtcpParameters.reducedSize && (n += "a=rtcp-rsize\r\n")
            }
        }));
        ...
        var t, r = this;
        return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise((function (n, i) {
            if (!r._remoteDescription) return i(X("InvalidStateError", "Can not add ICE candidate without a remote description"));
            if (e && "" !== e.candidate) {
                ...
                if (!s) return i(X("OperationError", "Can not add ICE candidate"));
                if (s.rejected) return n();
                var c = Object.keys(e.candidate).length > 0 ? W.parseCandidate(e.candidate) : {};
                if ("tcp" === c.protocol && (0 === c.port || 9 === c.port)) return n();
                if (c.component && 1 !== c.component) return n();
                if ((0 === o || o > 0 && s.iceTransport !== r.transceivers[0].iceTransport) && !Q(s.iceTransport, c)) return i(X("OperationError", "Can not add ICE candidate"));
                var p = e.candidate.trim();
                0 === p.indexOf("a=") && (p = p.substr(2)), (t = W.getMediaSections(r._remoteDescription.sdp))[o] += "a=" + (c.type ? p : "end-of-candidates") + "\r\n", r._remoteDescription.sdp = W.getDescription(r._remoteDescription.sdp) + t.join("")
            }
            else
                for (var d = 0; d < r.transceivers.length && (r.transceivers[d].rejected || (r.transceivers[d].iceTransport.addRemoteCandidate({}), (t = W.getMediaSections(r._remoteDescription.sdp))[d] += "a=end-of-candidates\r\n", r._remoteDescription.sdp = W.getDescription(r._remoteDescription.sdp) + t.join(""), !r.usingBundle)); d++);
            n()
        }))
        ...
        if (t && t instanceof e.MediaStreamTrack) {
            ...
            })), !r) throw X("InvalidAccessError", "Invalid selector.");
            return r.getStats()
        }
        var n = [];
...
function ne(e, t) {
    ...
    if (r.getUserMedia = function (e, t, n) {
        k("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"), r.mediaDevices.getUserMedia(e).then(t, n)
        ...
        if (r.mediaDevices.getUserMedia = function (e) {
            return "object" == typeof e && "object" == typeof e.audio && (e = JSON.parse(JSON.stringify(e)), i(e.audio, "autoGainControl", "mozAutoGainControl"), i(e.audio, "noiseSuppression", "mozNoiseSuppression")), o(e)
        ...
        if (n && n.prototype.applyConstraints) {
            ...
            n.prototype.applyConstraints = function (e) {
                return "audio" === this.kind && "object" == typeof e && (e = JSON.parse(JSON.stringify(e)), i(e, "autoGainControl", "mozAutoGainControl"), i(e, "noiseSuppression", "mozNoiseSuppression")), s.apply(this, [e])
            }
        }
    }
}
    ...
    if ("object" == typeof e && (e.RTCPeerConnection || e.mozRTCPeerConnection)) {
        ...
        e.RTCPeerConnection.prototype.getStats = function () {
            var e = s(arguments, 3),
                ...
                o = e[1],
                a = e[2];
            return n.apply(this, [i || null]).then((function (e) {
...
function pe(e) {
    e.RTCPeerConnection && !("removeStream" in e.RTCPeerConnection.prototype) && (e.RTCPeerConnection.prototype.removeStream = function (e) {
        var t = this;
        k("removeStream", "removeTrack"), this.getSenders().forEach((function (r) {
    ...
    if ("object" == typeof e && e.RTCPeerConnection) {
        ...
        t && (e.RTCPeerConnection.prototype.addTransceiver = function () {
            ...
            if (r) {
                var i = n.sender,
                    o = i.getParameters();
                (!("encodings" in o) || 1 === o.encodings.length && 0 === Object.keys(o.encodings[0]).length) && (o.encodings = e.sendEncodings, i.sendEncodings = e.sendEncodings, this.setParametersPromises.push(i.setParameters(o).then((function () {
        ...
        if ("getLocalStreams" in e.RTCPeerConnection.prototype || (e.RTCPeerConnection.prototype.getLocalStreams = function () {
            ...
            e.RTCPeerConnection.prototype.addStream = function (e) {
                ...
                return n && n.forEach((function (e) {
                    o._localStreams ? o._localStreams.includes(e) || o._localStreams.push(e) : o._localStreams = [e]
                })), t.apply(this, arguments)
            }
        }
        ...
        e.RTCPeerConnection = function (e, r) {
            if (e && e.iceServers) {
                for (var n = [], i = 0; i < e.iceServers.length; i++) {
                    ...
                    !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (k("RTCIceServer.url", "RTCIceServer.urls"), (o = JSON.parse(JSON.stringify(o))).urls = o.url, delete o.url, n.push(o)) : n.push(e.iceServers[i])
                }
                e.iceServers = n
            }
            return new t(e, r)
...
function Pe(t) {
    if (!(!t.RTCIceCandidate || t.RTCIceCandidate && "foundation" in t.RTCIceCandidate.prototype)) {
        ...
        t.RTCIceCandidate = function (t) {
            ...
            return new r(t)
        }, t.RTCIceCandidate.prototype = r.prototype, b(t, "icecandidate", (function (e) {
...
function Re(t, r) {
    if (t.RTCPeerConnection) {
        ...
        var n = function (t) {
                ...
                return r.shift(), r.some((function (t) {
            ...
            o = function (e) {
                var t = 65536;
                return "firefox" === r.browser && (t = r.version < 57 ? -1 === e ? 16384 : 2147483637 : r.version < 60 ? 57 === r.version ? 65535 : 65536 : 2147483637), t
            },
            a = function (t, n) {
                var i = 65536;
                "firefox" === r.browser && 57 === r.version && (i = 65535);
                var o = e(W).matchPrefix(t.sdp, "a=max-message-size:");
                return o.length > 0 ? i = parseInt(o[0].substr(19), 10) : "firefox" === r.browser && -1 !== n && (i = 2147483637), i
            },
        ...
        t.RTCPeerConnection.prototype.setRemoteDescription = function () {
            ...
            if (n(arguments[0])) {
                var t, c = i(arguments[0]),
                    p = o(c),
                    d = a(arguments[0], c);
                t = 0 === p && 0 === d ? Number.POSITIVE_INFINITY : 0 === p || 0 === d ? Math.max(p, d) : Math.min(p, d);
                var u = {};
...
var Ie, Me, je = function () {
        ...
        switch (n.browser) {
        case "chrome":
            if (!D || !D.shimPeerConnection || !t.shimChrome) return r("Chrome shim is not included in this adapter release."), i;
            if (null === n.version) return r("Chrome shim can not determine version, not shimming."), i;
            r("adapter.js shimming chrome."), i.browserShim = D, we.shimAddIceCandidateNullOrEmpty(e, n), D.shimGetUserMedia(e, n), D.shimMediaStream(e, n), D.shimPeerConnection(e, n), D.shimOnTrack(e, n), D.shimAddTrackRemoveTrack(e, n), D.shimGetSendersWithDtmf(e, n), D.shimGetStats(e, n), D.shimSenderReceiverGetStats(e, n), D.fixNegotiationNeeded(e, n), we.shimRTCIceCandidate(e, n), we.shimConnectionState(e, n), we.shimMaxMessageSize(e, n), we.shimSendThrowTypeError(e, n), we.removeExtmapAllowMixed(e, n);
            break;
        case "firefox":
            if (!re || !re.shimPeerConnection || !t.shimFirefox) return r("Firefox shim is not included in this adapter release."), i;
            r("adapter.js shimming firefox."), i.browserShim = re, we.shimAddIceCandidateNullOrEmpty(e, n), re.shimGetUserMedia(e, n), re.shimPeerConnection(e, n), re.shimOnTrack(e, n), re.shimRemoveStream(e, n), re.shimSenderGetStats(e, n), re.shimReceiverGetStats(e, n), re.shimRTCDataChannel(e, n), re.shimAddTransceiver(e, n), re.shimGetParameters(e, n), re.shimCreateOffer(e, n), re.shimCreateAnswer(e, n), we.shimRTCIceCandidate(e, n), we.shimConnectionState(e, n), we.shimMaxMessageSize(e, n), we.shimSendThrowTypeError(e, n);
            break;
        case "edge":
            if (!V || !V.shimPeerConnection || !t.shimEdge) return r("MS edge shim is not included in this adapter release."), i;
            r("adapter.js shimming edge."), i.browserShim = V, V.shimGetUserMedia(e, n), V.shimGetDisplayMedia(e, n), V.shimPeerConnection(e, n), V.shimReplaceTrack(e, n), we.shimMaxMessageSize(e, n), we.shimSendThrowTypeError(e, n);
            break;
        case "safari":
            if (!me || !t.shimSafari) return r("Safari shim is not included in this adapter release."), i;
            r("adapter.js shimming safari."), i.browserShim = me, we.shimAddIceCandidateNullOrEmpty(e, n), me.shimRTCIceServerUrls(e, n), me.shimCreateOfferLegacy(e, n), me.shimCallbacksAPI(e, n), me.shimLocalStreamsAPI(e, n), me.shimRemoteStreamsAPI(e, n), me.shimTrackEventTransceiver(e, n), me.shimGetUserMedia(e, n), me.shimAudioContext(e, n), we.shimRTCIceCandidate(e, n), we.shimMaxMessageSize(e, n), we.shimSendThrowTypeError(e, n), we.removeExtmapAllowMixed(e, n);
            break;
        default:
    ...
    Le = new((Ie = function () {
        ...
        return Ae.browserDetails.browser
    }, Ie.prototype.getVersion = function () {
        return Ae.browserDetails.version || 0
    }, Ie.prototype.isUnifiedPlanSupported = function () {
        var e, t = this.getBrowser(),
            r = Ae.browserDetails.version || 0;
    ...
    Ne = new((Me = function () {
        this.CLOUD_HOST = "0.peerjs.com", this.CLOUD_PORT = 443, this.chunkedBrowsers = {
            Chrome: 1,
            chrome: 1
        }, this.chunkedMTU = 16300, this.defaultConfig = Be, this.browser = Le.getBrowser(), this.browserVersion = Le.getVersion(), this.supports = function () {
            var e, t = {
                browser: Le.isBrowserSupported(),
                webRTC: Le.isWebRTCSupported(),
                audioVideo: !1,
                data: !1,
                binaryBlob: !1,
                reliable: !1
            ...
            try {
                e = new RTCPeerConnection(Be), t.audioVideo = !0;
                var r = void 0;
                try {
                    ...
                    try {
                        r.binaryType = "blob", t.binaryBlob = !Le.isIOS
                    }
                    catch (e) {}
                }
                catch (e) {}
    ...
    }).prototype.noop = function () {}, Me.prototype.validateId = function (e) {
        return !e || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e)
    }, Me.prototype.chunk = function (e) {
        for (var t = [], r = e.size, n = Math.ceil(r / Ne.chunkedMTU), i = 0, o = 0; o < r;) {
            var a = Math.min(r, o + Ne.chunkedMTU),
                s = e.slice(o, a),
                c = {
...
var Ue, ze = Object.prototype.hasOwnProperty,
    Ge = "~";
...
function We(e, t, r, n, i) {
    ...
    var o = new Je(r, n || e, i),
        a = Ge ? Ge + t : t;
    return e._events[a] ? e._events[a].fn ? e._events[a] = [e._events[a], o] : e._events[a].push(o) : (e._events[a] = o, e._eventsCount++), e
}

function He(e, t) {
    0 == --e._eventsCount ? e._events = new Ve : delete e._events[t]
}

function Ke() {
    this._events = new Ve, this._eventsCount = 0
}
Object.create && (Ve.prototype = Object.create(null), (new Ve).__proto__ || (Ge = !1)), Ke.prototype.eventNames = function () {
    var e, t, r = [];
    if (0 === this._eventsCount) return r;
    for (t in e = this._events) ze.call(e, t) && r.push(Ge ? t.slice(1) : t);
...
}, Ke.prototype.emit = function (e, t, r, n, i, o) {
    var a = Ge ? Ge + e : e;
    if (!this._events[a]) return !1;
    var s, c, p = this._events[a],
        d = arguments.length;
    if (p.fn) {
        ...
        var u, l = p.length;
        for (c = 0; c < l; c++) switch (p[c].once && this.removeListener(e, p[c].fn, void 0, !0), d) {
        case 1:
    ...
    return !0
}, Ke.prototype.on = function (e, t, r) {
    return We(this, e, t, r, !1)
}, Ke.prototype.once = function (e, t, r) {
    return We(this, e, t, r, !0)
}, Ke.prototype.removeListener = function (e, t, r, n) {
    var i = Ge ? Ge + e : e;
    if (!this._events[i]) return this;
    if (!t) return He(this, i), this;
    var o = this._events[i];
    if (o.fn) o.fn !== t || n && !o.once || r && o.context !== r || He(this, i);
    else {
        for (var a = 0, s = [], c = o.length; a < c; a++)(o[a].fn !== t || n && !o[a].once || r && o[a].context !== r) && s.push(o[a]);
        s.length ? this._events[i] = 1 === s.length ? s[0] : s : He(this, i)
    }
    return this
}, Ke.prototype.removeAllListeners = function (e) {
    var t;
    return e ? (t = Ge ? Ge + e : e, this._events[t] && He(this, t)) : (this._events = new Ve, this._eventsCount = 0), this
}, Ke.prototype.off = Ke.prototype.removeListener, Ke.prototype.addListener = Ke.prototype.on, Ke.prefixed = Ge, Ke.EventEmitter = Ke, Ue = Ke;
var Ye = {};
t(Ye, "LogLevel", (function () {
    return qe
}), (function (e) {
    return qe = e
})), t(Ye, "default", (function () {
    return ot
}), (function (e) {
    return ot = e
}));
var qe, Qe = function (e, t) {
...
var Ze, $e, et, tt, rt, nt, it, ot = new(Ze = function () {
        this._logLevel = qe.Disabled
    }, Object.defineProperty(Ze.prototype, "logLevel", {
        get: function () {
        ...
        this._logLevel >= qe.All && this._print.apply(this, Xe([qe.All], Qe(e), !1))
    }, Ze.prototype.warn = function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        this._logLevel >= qe.Warnings && this._print.apply(this, Xe([qe.Warnings], Qe(e), !1))
    }, Ze.prototype.error = function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        this._logLevel >= qe.Errors && this._print.apply(this, Xe([qe.Errors], Qe(e), !1))
    }, Ze.prototype.setLogFunction = function (e) {
        this._print = e
    }, Ze.prototype._print = function (e) {
        for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
        var n = Xe(["PeerJS: "], Qe(t), !1);
        for (var i in n) n[i] instanceof Error && (n[i] = "(" + n[i].name + ") " + n[i].message);
        e >= qe.All ? console.log.apply(console, Xe([], Qe(n), !1)) : e >= qe.Warnings ? console.warn.apply(console, Xe(["WARNING"], Qe(n), !1)) : e >= qe.Errors && console.error.apply(console, Xe(["ERROR"], Qe(n), !1))
    }, Ze),
    at = {};
t(at, "Socket", (function () {
        return ft
    }), (function (e) {
        return ft = e
    })),
...
var st;
st = JSON.parse('{"name":"peerjs","version":"1.4.5","keywords":["peerjs","webrtc","p2p","rtc"],"description":"PeerJS client","homepage":"https://peerjs.com","bugs":{"url":"https://github.com/peers/peerjs/issues"},"repository":{"type":"git","url":"https://github.com/peers/peerjs"},"license":"MIT","contributors":["Michelle Bu <michelle@michellebu.com>","afrokick <devbyru@gmail.com>","ericz <really.ez@gmail.com>","Jairo <kidandcat@gmail.com>","Jonas Gloning <34194370+jonasgloning@users.noreply.github.com>","Jairo Caro-Accino Viciana <jairo@galax.be>","Carlos Caballero <carlos.caballero.gonzalez@gmail.com>","hc <hheennrryy@gmail.com>","Muhammad Asif <capripio@gmail.com>","PrashoonB <prashoonbhattacharjee@gmail.com>","akotynski <aleksanderkotbury@gmail.com>","Harsh Bardhan Mishra <47351025+HarshCasper@users.noreply.github.com>","Jairooo <jairocaro@msn.com>","lmb <i@lmb.io>","Moritz Stückler <moritz.stueckler@gmail.com>","Denis Lukov <denismassters@gmail.com>","DUODVK <kurmanov.work@gmail.com>","Hans Oksendahl <hansoksendahl@gmail.com>","Jess <jessachandler@gmail.com>","khankuan <khankuan@gmail.com>","Matthias Lohr <matthias@lohr.me>","Philipp Hancke <fippo@andyet.net>","Simon <crydotsnakegithub@gmail.com>","XiZhao <kwang1imsa@gmail.com>","=frank tree <=frnktrb@googlemail.com>","Alberto Torres <kungfoobar@gmail.com>","Alex Chuev <alex@chuev.com>","alxnull <alxnull@e.mail.de>","Andre Eckardt <aeckardt@outlook.com>","Arpit Solanki <solankiarpit1997@gmail.com>","Artur Zayats <zag2art@gmail.com>","Ben Parnell <benjaminparnell.94@gmail.com>","Benny Lichtner <bennlich@gmail.com>","bob.barstead@exaptive.com <bob.barstead@exaptive.com>","chandika <chandika@gmail.com>","Chris Cowan <agentme49@gmail.com>","Christopher Van <cvan@users.noreply.github.com>","Diwank Singh Tomer <singh@diwank.name>","eddieherm <edhermoso@gmail.com>","Eduardo Pinho <enet4mikeenet@gmail.com>","emersion <contact@emersion.fr>","Evandro Zanatta <ezanatta@tray.net.br>","fresheneesz <bitetrudpublic@gmail.com>","Gardner Bickford <gardner@users.noreply.github.com>","Gian Luca <gianluca.cecchi@cynny.com>","Hizkia Felix <hizkifw@gmail.com>","Hristo Oskov <hristo.oskov@gmail.com>","Ilya Konanykhin <ilya.konanykhin@gmail.com>","Isaac Madwed <i.madwed@gmail.com>","jasonbarry <jasbarry@me.com>","Jefferson Felix <me@jsfelix.dev>","Jonathan Burke <jonathan.burke.1311@googlemail.com>","Jonathan Mayol <mayoljonathan@gmail.com>","jonnyf <github@jonathanfoss.co.uk>","JooYoung <qkdlql@naver.com>","Jordan Austin <jrax86@gmail.com>","Josh Hamit <josh.hamit@gmail.com>","Kevin Mai-Husan Chia <mhchia@users.noreply.github.com>","Kyrylo Shegeda <shegeda@ualberta.ca>","PatrickJS <github@gdi2290.com>","Pepijn de Vos <pepijndevos@gmail.com>","Rolf Erik Lekang <me@rolflekang.com>","Sören Balko <Soeren.Balko@gmail.com>","Steve Blaurock <sblaurock@gmail.com>","Tobias Speicher <rootcommander@gmail.com>","xizhao <kevin.wang@cloudera.com>","Yemel Jardi <angel.jardi@gmail.com>","Yuki Ito <yuki@gnnk.net>"],"funding":{"type":"opencollective","url":"https://opencollective.com/peer"},"collective":{"type":"opencollective","url":"https://opencollective.com/peer"},"files":["dist/*"],"type":"module","sideEffects":["lib/global.ts","lib/supports.ts"],"main":"dist/bundler.cjs","module":"dist/bundler.mjs","browser-minified":"dist/peerjs.min.cjs","browser-unminified":"dist/peerjs.cjs","types":"dist/types.d.ts","engines":{"node":">= 10"},"targets":{"types":{"source":"lib/exports.ts"},"main":{"source":"lib/exports.ts","sourceMap":{"inlineSources":true}},"module":{"source":"lib/exports.ts","includeNodeModules":["eventemitter3"],"sourceMap":{"inlineSources":true}},"browser-minified":{"includeNodeModules":true,"context":"browser","optimize":true,"engines":{"browsers":"cover 99%, not dead"},"source":"lib/global.ts"},"browser-unminified":{"includeNodeModules":true,"context":"browser","optimize":false,"engines":{"browsers":"cover 99%, not dead"},"source":"lib/global.ts"}},"scripts":{"check":"tsc --noEmit","watch":"parcel watch","build":"rm -rf dist && parcel build && cp dist/peerjs.cjs dist/peerjs.js && cp dist/peerjs.min.cjs dist/peerjs.min.js","prepublishOnly":"npm run build","test":"mocha -r ts-node/register -r jsdom-global/register test/**/*.ts","format":"prettier --write .","semantic-release":"semantic-release"},"devDependencies":{"@parcel/config-default":"^2.5.0","@parcel/packager-ts":"^2.5.0","@parcel/transformer-typescript-tsc":"^2.5.0","@parcel/transformer-typescript-types":"^2.5.0","@semantic-release/changelog":"^6.0.1","@semantic-release/git":"^10.0.1","@types/chai":"^4.3.0","@types/mocha":"^9.1.0","@types/node":"^17.0.18","chai":"^4.3.6","jsdom":"^19.0.0","jsdom-global":"^3.0.2","mocha":"^9.2.0","mock-socket":"8.0.5","parcel":"^2.5.0","parcel-transformer-tsc-sourcemaps":"^1.0.2","prettier":"^2.6.2","semantic-release":"^19.0.2","standard":"^16.0.4","ts-node":"^10.5.0","typescript":"^4.5.5"},"dependencies":{"@swc/helpers":"^0.3.13","eventemitter3":"^4.0.7","peerjs-js-binarypack":"1.0.1","webrtc-adapter":"^7.7.1"}}');
var ct, pt = (ct = function (e, t) {
        ...
        ct(e, t), e.prototype = null === t ? Object.create(t) : (r.prototype = t.prototype, new r)
    }),
    dt = function (e, t) {
        var r = "function" == typeof Symbol && e[Symbol.iterator];
        if (!r) return e;
    ...
    ft = function (e) {
        ...
        return pt(t, e), t.prototype.start = function (e, t) {
            var r = this;
            this._id = e;
            var n = "".concat(this._baseUrl, "&id=").concat(e, "&token=").concat(t);
            !this._socket && this._disconnected && (this._socket = new WebSocket(n + "&version=" + st.version), this._disconnected = !1, this._socket.onmessage = function (e) {
                var t;
                try {
                    t = JSON.parse(e.data), Ye.default.log("Server message received:", t)
                }
                catch (t) {
                    return void Ye.default.log("Invalid server message", e.data)
                }
                r.emit(nt.Message, t)
            }, this._socket.onclose = function (e) {
                r._disconnected || (Ye.default.log("Socket closed.", e), r._cleanup(), r._disconnected = !0, r.emit(nt.Disconnected))
            }, this._socket.onopen = function () {
                r._disconnected || (r._sendQueuedMessages(), Ye.default.log("Socket open"), r._scheduleHeartbeat())
            })
            ...
            else Ye.default.log("Cannot send heartbeat, because socket closed")
        }, t.prototype._wsOpen = function () {
            return !!this._socket && 1 === this._socket.readyState
        }, t.prototype._sendQueuedMessages = function () {
            var e, t, r = ut([], dt(this._messagesQueue), !1);
            this._messagesQueue = [];
            try {
                for (var n = lt(r), i = n.next(); !i.done; i = n.next()) {
                    var o = i.value;
                    this.send(o)
                }
            }
            ...
            if (!this._disconnected)
                if (this._id)
                    ...
                    else this.emit(nt.Error, "Invalid message");
    ...
    ht = {};
t(ht, "MediaConnection", (function () {
    return Pt
}), (function (e) {
    return Pt = e
}));
var mt = {};
t(mt, "Negotiator", (function () {
    return Ct
}), (function (e) {
    return Ct = e
}));
var vt = function () {
    ...
    Ct = function () {
        ...
        return e.prototype.startConnection = function (e) {
            ...
            if (this.connection.peerConnection = t, this.connection.type === et.Media && e._stream && this._addTracksToConnection(e._stream, t), e.originator) {
                if (this.connection.type === et.Data) {
            ...
            Ye.default.log("Creating RTCPeerConnection.");
            ...
            Ye.default.log("Listening for ICE candidates."), e.onicecandidate = function (e) {
                e.candidate && e.candidate.candidate && (Ye.default.log("Received ICE candidates for ".concat(r, ":"), e.candidate), o.socket.send({
                    type: it.Candidate,
                    payload: {
                ...
                case "failed":
                    Ye.default.log("iceConnectionState is failed, closing connections to " + r), t.connection.emit($e.Error, new Error("Negotiation of connection to " + r + " failed.")), t.connection.close();
                    break;
                case "closed":
                    Ye.default.log("iceConnectionState is closed, closing connections to " + r), t.connection.emit($e.Error, new Error("Connection to " + r + " closed.")), t.connection.close();
                    break;
                case "disconnected":
                    Ye.default.log("iceConnectionState changed to disconnected on the connection with " + r);
                    break;
                case "completed":
                    e.onicecandidate = Ne.noop
                }
                t.connection.emit($e.IceStateChanged, e.iceConnectionState)
            }, Ye.default.log("Listening for data channel"), e.ondatachannel = function (e) {
                Ye.default.log("Received data channel");
                var t = e.channel;
                o.getConnection(r, n).initialize(t)
            }, Ye.default.log("Listening for remote stream"), e.ontrack = function (e) {
                Ye.default.log("Received remote stream");
                var i = e.streams[0],
            ...
            Ye.default.log("Cleaning up PeerConnection to " + this.connection.peer);
            ...
            return yt(this, void 0, Promise, (function () {
                var e, t, r, n, i, o, a;
                return gt(this, (function (s) {
                    switch (s.label) {
                    case 0:
                        e = this.connection.peerConnection, t = this.connection.provider, s.label = 1;
                    case 1:
                        return s.trys.push([1, 7, , 8]), [4, e.createOffer(this.connection.options.constraints)];
                    case 2:
                        r = s.sent(), Ye.default.log("Created offer."), this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (r.sdp = this.connection.options.sdpTransform(r.sdp) || r.sdp), s.label = 3;
                    case 3:
                        return s.trys.push([3, 5, , 6]), [4, e.setLocalDescription(r)];
                    case 4:
                        return s.sent(), Ye.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)), n = {
                            sdp: r,
                            type: this.connection.type,
                            connectionId: this.connection.connectionId,
                            metadata: this.connection.metadata,
                            browser: Ne.browser
                        }, this.connection.type === et.Data && (i = this.connection, n = vt(vt({}, n), {
                            label: i.label,
                            reliable: i.reliable,
                    ...
                    case 5:
                        return "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (o = s.sent()) && (t.emitError(tt.WebRTC, o), Ye.default.log("Failed to setLocalDescription, ", o)), [3, 6];
                    case 6:
                        return [3, 8];
                    case 7:
                        return a = s.sent(), t.emitError(tt.WebRTC, a), Ye.default.log("Failed to createOffer, ", a), [3, 8];
                    case 8:
                        return [2]
                    }
                }))
            ...
            return yt(this, void 0, Promise, (function () {
                ...
                return gt(this, (function (o) {
                    ...
                    case 2:
                        r = o.sent(), Ye.default.log("Created answer."), this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (r.sdp = this.connection.options.sdpTransform(r.sdp) || r.sdp), o.label = 3;
                    case 3:
                        return o.trys.push([3, 5, , 6]), [4, e.setLocalDescription(r)];
                    case 4:
                        return o.sent(), Ye.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)), t.socket.send({
                            type: it.Answer,
                            payload: {
                                sdp: r,
                                type: this.connection.type,
                    ...
                    case 5:
                        return n = o.sent(), t.emitError(tt.WebRTC, n), Ye.default.log("Failed to setLocalDescription, ", n), [3, 6];
                    case 6:
                        return [3, 8];
                    case 7:
                        return i = o.sent(), t.emitError(tt.WebRTC, i), Ye.default.log("Failed to create answer, ", i), [3, 8];
                    case 8:
                        return [2]
                    }
                }))
            ...
            return yt(this, void 0, Promise, (function () {
                ...
                return gt(this, (function (a) {
                    switch (a.label) {
                    case 0:
                        t = new RTCSessionDescription(t), r = this.connection.peerConnection, n = this.connection.provider, Ye.default.log("Setting remote description", t), i = this, a.label = 1;
                    case 1:
                        return a.trys.push([1, 5, , 6]), [4, r.setRemoteDescription(t)];
                    case 2:
                        return a.sent(), Ye.default.log("Set remoteDescription:".concat(e, " for:").concat(this.connection.peer)), "OFFER" !== e ? [3, 4] : [4, i._makeAnswer()];
                    case 3:
                        a.sent(), a.label = 4;
                    case 4:
                        return [3, 6];
                    case 5:
                        return o = a.sent(), n.emitError(tt.WebRTC, o), Ye.default.log("Failed to setRemoteDescription, ", o), [3, 6];
                    case 6:
                        return [2]
                    }
                }))
            ...
            return yt(this, void 0, Promise, (function () {
                ...
                return gt(this, (function (s) {
                    switch (s.label) {
                    case 0:
                        Ye.default.log("handleCandidate:", e), t = e.candidate, r = e.sdpMLineIndex, n = e.sdpMid, i = this.connection.peerConnection, o = this.connection.provider, s.label = 1;
                    case 1:
                        return s.trys.push([1, 3, , 4]), [4, i.addIceCandidate(new RTCIceCandidate({
                            sdpMid: n,
                            sdpMLineIndex: r,
                            candidate: t
                        }))];
                    case 2:
                        return s.sent(), Ye.default.log("Added ICE candidate for:".concat(this.connection.peer)), [3, 4];
                    case 3:
                        return a = s.sent(), o.emitError(tt.WebRTC, a), Ye.default.log("Failed to handleCandidate, ", a), [3, 4];
                    case 4:
                        return [2]
                    }
                }))
            ...
            if (Ye.default.log("add tracks from stream ".concat(e.id, " to peer connection")), !t.addTrack) return Ye.default.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
            e.getTracks().forEach((function (r) {
                t.addTrack(r, e)
            }))
        }, e.prototype._addStreamToMediaConnection = function (e, t) {
            Ye.default.log("add stream ".concat(e.id, " to media connection ").concat(t.connectionId)), t.addStream(e)
        }, e
    }(),
    bt = {};
t(bt, "BaseConnection", (function () {
    return St
}), (function (e) {
    return St = e
}));
var _t = function () {
    ...
    St = function (e) {
        ...
        return _t(t, e), Object.defineProperty(t.prototype, "open", {
            get: function () {
                return this._open
            }, enumerable: !1,
            configurable: !0
    ...
    Pt = function (e) {
        function t(r, n, i) {
            ...
            return o._localStream = o.options._stream, o.connectionId = o.options.connectionId || t.ID_PREFIX + Ne.randomToken(), o._negotiator = new mt.Negotiator(o), o._localStream && o._negotiator.startConnection({
                _stream: o._localStream,
                originator: !0
            }), o
        }
        return Tt(t, e), Object.defineProperty(t.prototype, "type", {
            get: function () {
                return et.Media
            }, enumerable: !1,
            configurable: !0
            ...
            Ye.default.log("Receiving stream", t), this._remoteStream = t, e.prototype.emit.call(this, $e.Stream, t)
            ...
            case it.Candidate:
                ...
                break;
            default:
                Ye.default.warn("Unrecognized message type:".concat(t, " from peer:").concat(this.peer))
            }
        }, t.prototype.answer = function (e, t) {
            var r, n;
            if (void 0 === t && (t = {}), this._localStream) Ye.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
            else {
                this._localStream = e, t && t.sdpTransform && (this.options.sdpTransform = t.sdpTransform), this._negotiator.startConnection(kt(kt({}, this.options._payload), {
                    _stream: e
                }));
                var i = this.provider._getMessages(this.connectionId);
                try {
                    for (var o = wt(i), a = o.next(); !a.done; a = o.next()) {
                        var s = a.value;
            ...
            this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this._localStream = null, this._remoteStream = null, this.provider && (this.provider._removeConnection(this), this.provider = null), this.options && this.options._stream && (this.options._stream = null), this.open && (this._open = !1, e.prototype.emit.call(this, $e.Close))
        }, t.ID_PREFIX = "mc_", t
    }(bt.BaseConnection),
    Rt = {};
t(Rt, "DataConnection", (function () {
    return Mt
}), (function (e) {
    return Mt = e
}));
var Et = {};
t(Et, "EncodingQueue", (function () {
    return Dt
}), (function (e) {
    return Dt = e
}));
var xt = function () {
    ...
    Dt = function (e) {
        var t = function () {
            ...
            return t.fileReader = new FileReader, t._queue = [], t._processing = !1, t.fileReader.onload = function (e) {
                t._processing = !1, e.target && t.emit("done", e.target.result), t.doNextTask()
            }, t.fileReader.onerror = function (e) {
                Ye.default.error("EncodingQueue error:", e), t._processing = !1, t.destroy(), t.emit("error", e)
            }, t
        };
        return xt(t, e), Object.defineProperty(t.prototype, "queue", {
            get: function () {
                return this._queue
            }, enumerable: !1,
            configurable: !0
    ...
    Mt = function (e) {
        function t(r, n, i) {
            var o = e.call(this, r, n, i) || this;
            return o.stringify = JSON.stringify, o.parse = JSON.parse, o._buffer = [], o._bufferSize = 0, o._buffering = !1, o._chunkedData = {}, o._encodingQueue = new Et.EncodingQueue, o.connectionId = o.options.connectionId || t.ID_PREFIX + Ne.randomToken(), o.label = o.options.label || o.connectionId, o.serialization = o.options.serialization || rt.Binary, o.reliable = !!o.options.reliable, o._encodingQueue.on("done", (function (e) {
                o._bufferedSend(e)
            })), o._encodingQueue.on("error", (function () {
                Ye.default.error("DC#".concat(o.connectionId, ": Error occured in encoding from blob to arraybuffer, close DC")), o.close()
            })), o._negotiator = new mt.Negotiator(o), o._negotiator.startConnection(o.options._payload || {
                originator: !0
            }), o
        }
        return Ot(t, e), Object.defineProperty(t.prototype, "type", {
            get: function () {
                return et.Data
            }, enumerable: !1,
            configurable: !0
            ...
            var e = this;
            Ne.supports.binaryBlob && !Ne.supports.reliable || (this.dataChannel.binaryType = "arraybuffer"), this.dataChannel.onopen = function () {
                Ye.default.log("DC#".concat(e.connectionId, " dc connection success")), e._open = !0, e.emit($e.Open)
            }, this.dataChannel.onmessage = function (t) {
                Ye.default.log("DC#".concat(e.connectionId, " dc onmessage:"), t.data), e._handleDataMessage(t)
            }, this.dataChannel.onclose = function () {
                Ye.default.log("DC#".concat(e.connectionId, " dc closed for:"), e.peer), e.close()
            }
            ...
            var r = this,
                ...
                i = n.constructor,
                o = n;
            if (this.serialization === rt.Binary || this.serialization === rt.BinaryUTF8) {
                if (i === Blob) return void Ne.blobToArrayBuffer(n, (function (e) {
                    var t = Ne.unpack(e);
                    r.emit($e.Data, t)
                }));
                if (i === ArrayBuffer) o = Ne.unpack(n);
                else if (i === String) {
                    var a = Ne.binaryStringToArrayBuffer(n);
                    o = Ne.unpack(a)
                }
            }
            else this.serialization === rt.JSON && (o = this.parse(n));
            o.__peerData ? this._handleChunk(o) : e.prototype.emit.call(this, $e.Data, o)
        }, t.prototype._handleChunk = function (e) {
            var t = e.__peerData,
                r = this._chunkedData[t] || {
                    data: [],
                    count: 0,
                    total: e.total
                };
            ...
            this._buffer = [], this._bufferSize = 0, this._chunkedData = {}, this._negotiator && (this._negotiator.cleanup(), this._negotiator = null), this.provider && (this.provider._removeConnection(this), this.provider = null), this.dataChannel && (this.dataChannel.onopen = null, this.dataChannel.onmessage = null, this.dataChannel.onclose = null, this._dc = null), this._encodingQueue && (this._encodingQueue.destroy(), this._encodingQueue.removeAllListeners(), this._encodingQueue = null), this.open && (this._open = !1, e.prototype.emit.call(this, $e.Close))
        }, t.prototype.send = function (t, r) {
            if (this.open)
                if (this.serialization === rt.JSON) this._bufferedSend(this.stringify(t));
                else if (this.serialization === rt.Binary || this.serialization === rt.BinaryUTF8) {
                var n = Ne.pack(t);
                if (!r && n.size > Ne.chunkedMTU) return void this._sendChunks(n);
                Ne.supports.binaryBlob ? this._bufferedSend(n) : this._encodingQueue.enque(n)
            }
            else this._bufferedSend(t);
            else e.prototype.emit.call(this, $e.Error, new Error("Connection is not open. You should listen for the `open` event before sending messages."))
            ...
            if (this.dataChannel.bufferedAmount > t.MAX_BUFFERED_AMOUNT) return this._buffering = !0, setTimeout((function () {
            ...
            try {
                ...
                return Ye.default.error("DC#:".concat(this.connectionId, " Error when sending:"), e), this._buffering = !0, this.close(), !1
            }
            return !0
            ...
            var t, r, n = Ne.chunk(e);
            Ye.default.log("DC#".concat(this.connectionId, " Try to send ").concat(n.length, " chunks..."));
            try {
                for (var i = It(n), o = i.next(); !o.done; o = i.next()) {
                    var a = o.value;
                    this.send(a, !0)
                }
            }
            ...
            case it.Candidate:
                ...
                break;
            default:
                Ye.default.warn("Unrecognized message type:", e.type, "from peer:", this.peer)
            }
...
var At = function (e, t, r, n) {
    ...
    Bt = function () {
        ...
        return e.prototype._buildRequest = function (e) {
            var t = this._options.secure ? "https" : "http",
                ...
                o = r.path,
                a = r.key,
                s = new URL("".concat(t, "://").concat(n, ":").concat(i).concat(o).concat(a, "/").concat(e));
            return s.searchParams.set("ts", "".concat(Date.now()).concat(Math.random())), s.searchParams.set("version", st.version), fetch(s.href, {
            ...
            return At(this, void 0, Promise, (function () {
                ...
                return Lt(this, (function (n) {
                    switch (n.label) {
                    case 0:
                        return n.trys.push([0, 2, , 3]), [4, this._buildRequest("id")];
                    case 1:
                        if (200 !== (e = n.sent()).status) throw new Error("Error. Status:".concat(e.status));
                        return [2, e.text()];
                    case 2:
                        throw t = n.sent(), Ye.default.error("Error retrieving ID", t), r = "", "/" === this._options.path && this._options.host !== Ne.CLOUD_HOST && (r = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."), new Error("Could not get an ID from the server." + r);
                    case 3:
                        return [2]
                    }
                }))
            ...
            return At(this, void 0, Promise, (function () {
                ...
                return Lt(this, (function (n) {
                    switch (n.label) {
                    case 0:
                        return n.trys.push([0, 2, , 3]), [4, this._buildRequest("peers")];
                    case 1:
                        if (200 !== (e = n.sent()).status) {
                            if (401 === e.status) throw t = "", t = this._options.host === Ne.CLOUD_HOST ? "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.", new Error("It doesn't look like you have permission to list peers IDs. " + t);
                            throw new Error("Error. Status:".concat(e.status))
                        }
                        return [2, e.json()];
                    case 2:
                        throw r = n.sent(), Ye.default.error("Error retrieving list peers", r), new Error("Could not get list peers from the server." + r);
                    case 3:
                        return [2]
                    }
                }))
    ...
    Gt = function (e) {
        function t(r, n) {
            ...
            return o._id = null, o._lastServerId = null, o._destroyed = !1, o._disconnected = !1, o._open = !1, o._connections = new Map, o._lostMessages = new Map, r && r.constructor == Object ? n = r : r && (i = r.toString()), n = Ft({
                debug: 0,
                host: Ne.CLOUD_HOST,
                port: Ne.CLOUD_PORT,
                path: "/",
                key: t.DEFAULT_KEY,
                token: Ne.randomToken(),
                config: Ne.defaultConfig,
                referrerPolicy: "strict-origin-when-cross-origin"
            }, n), o._options = n, "/" === o._options.host && (o._options.host = window.location.hostname), o._options.path && ("/" !== o._options.path[0] && (o._options.path = "/" + o._options.path), "/" !== o._options.path[o._options.path.length - 1] && (o._options.path += "/")), void 0 === o._options.secure && o._options.host !== Ne.CLOUD_HOST ? o._options.secure = Ne.isSecure() : o._options.host == Ne.CLOUD_HOST && (o._options.secure = !0), o._options.logFunction && Ye.default.setLogFunction(o._options.logFunction), Ye.default.logLevel = o._options.debug || 0, o._api = new jt.API(n), o._socket = o._createServerConnection(), Ne.supports.audioVideo || Ne.supports.data ? i && !Ne.validateId(i) ? (o._delayedAbort(tt.InvalidID, 'ID "'.concat(i, '" is invalid')), o) : (i ? o._initialize(i) : o._api.retrieveId().then((function (e) {
                return o._initialize(e)
            })).catch((function (e) {
                return o._abort(tt.ServerError, e)
            })), o) : (o._delayedAbort(tt.BrowserIncompatible, "The current browser does not support WebRTC"), o)
        }
        return Nt(t, e), Object.defineProperty(t.prototype, "id", {
            get: function () {
                return this._id
            }, enumerable: !1,
            configurable: !0
            ...
            get: function () {
                ...
                try {
                    for (var n = Ut(this._connections), i = n.next(); !i.done; i = n.next()) {
                        var o = zt(i.value, 2),
                            a = o[0],
                            s = o[1];
                        r[a] = s
            ...
            var e = this,
                t = new at.Socket(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval);
            return t.on(nt.Message, (function (t) {
                e._handleMessage(t)
            })), t.on(nt.Error, (function (t) {
                e._abort(tt.SocketError, t)
            })), t.on(nt.Disconnected, (function () {
                e.disconnected || (e.emitError(tt.Network, "Lost connection to server."), e.disconnect())
            })), t.on(nt.Close, (function () {
                e.disconnected || e._abort(tt.SocketClosed, "Underlying socket is already closed.")
            })), t
            ...
            case it.Open:
                ...
                break;
            case it.Error:
                this._abort(tt.ServerError, i.msg);
                break;
            case it.IdTaken:
                this._abort(tt.UnavailableID, 'ID "'.concat(this.id, '" is taken'));
                break;
            case it.InvalidKey:
                this._abort(tt.InvalidKey, 'API KEY "'.concat(this._options.key, '" is invalid'));
                break;
            case it.Leave:
                Ye.default.log("Received leave message from ".concat(o)), this._cleanupPeer(o), this._connections.delete(o);
                break;
            case it.Expire:
                this.emitError(tt.PeerUnavailable, "Could not connect to peer ".concat(o));
                break;
            case it.Offer:
                var a = i.connectionId;
                if ((f = this.getConnection(o, a)) && (f.close(), Ye.default.warn("Offer received for existing Connection ID:".concat(a))), i.type === et.Media) {
                    var s = new ht.MediaConnection(o, this, {
                        connectionId: a,
                        _payload: i,
                        metadata: i.metadata
                    });
                    ...
                    if (i.type !== et.Data) return void Ye.default.warn("Received malformed connection type:".concat(i.type));
                    var c = new Rt.DataConnection(o, this, {
                        connectionId: a,
                        _payload: i,
                        metadata: i.metadata,
                        label: i.label,
                ...
                break;
            default:
                if (!i) return void Ye.default.warn("You received a malformed message from ".concat(o, " of type ").concat(n));
                var f;
                a = i.connectionId;
                (f = this.getConnection(o, a)) && f.peerConnection ? f.handleMessage(e) : a ? this._storeMessage(a, e) : Ye.default.warn("You received an unrecognized message:", e)
            }
            ...
            if (void 0 === t && (t = {}), this.disconnected) return Ye.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."), void this.emitError(tt.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
            var r = new Rt.DataConnection(e, this, t);
            return this._addConnection(e, r), r
        }, t.prototype.call = function (e, t, r) {
            if (void 0 === r && (r = {}), this.disconnected) return Ye.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."), void this.emitError(tt.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
            if (t) {
                var n = new ht.MediaConnection(e, this, Ft(Ft({}, r), {
                    _stream: t
                }));
                return this._addConnection(e, n), n
            }
            Ye.default.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.")
        }, t.prototype._addConnection = function (e, t) {
            Ye.default.log("add connection ".concat(t.type, ":").concat(t.connectionId, " to peerId:").concat(e)), this._connections.has(e) || this._connections.set(e, []), this._connections.get(e).push(t)
            ...
            var r, n, i = this._connections.get(e);
            if (!i) return null;
            try {
                for (var o = Ut(i), a = o.next(); !a.done; a = o.next()) {
                    var s = a.value;
            ...
            Ye.default.error("Aborting!"), this.emitError(e, t), this._lastServerId ? this.disconnect() : this.destroy()
        }, t.prototype.emitError = function (e, t) {
            var r;
            Ye.default.error("Error:", t), (r = "string" == typeof t ? new Error(t) : t).type = e, this.emit("error", r)
        }, t.prototype.destroy = function () {
            this.destroyed || (Ye.default.log("Destroy peer with ID:".concat(this.id)), this.disconnect(), this._cleanup(), this._destroyed = !0, this.emit("close"))
        }, t.prototype._cleanup = function () {
            var e, t;
            try {
                for (var r = Ut(this._connections.keys()), n = r.next(); !n.done; n = r.next()) {
                    var i = n.value;
            ...
            var t, r, n = this._connections.get(e);
            if (n) try {
                for (var i = Ut(n), o = i.next(); !o.done; o = i.next()) {
                    o.value.close()
                }
            }
            catch (e) {
            ...
            if (!this.disconnected) {
                var e = this.id;
                Ye.default.log("Disconnect peer with ID:".concat(e)), this._disconnected = !0, this._open = !1, this.socket.close(), this._lastServerId = e, this._id = null, this.emit("disconnected", e)
            }
        }, t.prototype.reconnect = function () {
            if (this.disconnected && !this.destroyed) Ye.default.log("Attempting reconnection to server with ID ".concat(this._lastServerId)), this._disconnected = !1, this._initialize(this._lastServerId);
            else {
                if (this.destroyed) throw new Error("This peer cannot reconnect to the server. It has already been destroyed.");
                if (this.disconnected || this.open) throw new Error("Peer ".concat(this.id, " cannot reconnect because it is not disconnected from the server!"));
                Ye.default.error("In a hurry? We're still trying to make the initial connection!")
            }
            ...
            void 0 === e && (e = function (e) {}), this._api.listAllPeers().then((function (t) {
                ...
                return t._abort(tt.ServerError, e)
            }))
